...
![在这里插入图片描述](https://img-blog.csdnimg.cn/41b4cea4df7d47c3b3151a4b87816e92.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA5pyI5Ly06aOe6bG8,size_20,color_FFFFFF,t_70,g_se,x_16)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/69ae608827da404f8fbc5ce395dbf9cc.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA5pyI5Ly06aOe6bG8,size_15,color_FFFFFF,t_70,g_se,x_16)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/d68cc06dd36240e68166c5794d1667e4.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA5pyI5Ly06aOe6bG8,size_20,color_FFFFFF,t_70,g_se,x_16)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/06fe2f788d594494a4e1a0431aa2f2f1.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA5pyI5Ly06aOe6bG8,size_20,color_FFFFFF,t_70,g_se,x_16)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/50377d9b2c99499cbb6fd5ec3500aee1.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA5pyI5Ly06aOe6bG8,size_20,color_FFFFFF,t_70,g_se,x_16)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/032dd16287b24c8fad38c932d134053e.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA5pyI5Ly06aOe6bG8,size_20,color_FFFFFF,t_70,g_se,x_16)
...
1. **垂直分区：**
   ...
   **简单来说垂直拆分是指数据表列的拆分，把一张列比较多的表拆分为多张表。** 如下图所示，这样来说大家应该就更容易理解了。
   ...
   ![在这里插入图片描述](https://img-blog.csdnimg.cn/31dd1ec480d949758332a8ca6b56b145.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA5pyI5Ly06aOe6bG8,size_20,color_FFFFFF,t_70,g_se,x_16)
   ...
   **垂直拆分的缺点：** 主键会出现冗余，需要管理冗余列，并会引起Join操作，可以通过在应用层进行Join来解决。此外，垂直分区会让事务变得更加复杂；
   ...
   ![在这里插入图片描述](https://img-blog.csdnimg.cn/e73737d447da42b390d77f73ffd48e7b.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA5pyI5Ly06aOe6bG8,size_20,color_FFFFFF,t_70,g_se,x_16)
...
2. **水平分区：**
   ...
   **保持数据表结构不变，通过某种策略存储数据分片。这样每一片数据分散到不同的表或者库中，达到了分布式的目的。 水平拆分可以支撑非常大的数据量。**
   ...
   ![在这里插入图片描述](https://img-blog.csdnimg.cn/8a1b0a1b87d0481489c7720f15392cb6.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA5pyI5Ly06aOe6bG8,size_20,color_FFFFFF,t_70,g_se,x_16)
   ...
   **水平分表：**
   ...
   ![在这里插入图片描述](https://img-blog.csdnimg.cn/9fc3bff465ef4b18b039b9313c115bdb.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA5pyI5Ly06aOe6bG8,size_20,color_FFFFFF,t_70,g_se,x_16)
...
- 跨分片的排序分页
  ...
  ![在这里插入图片描述](https://img-blog.csdnimg.cn/18052ec0615045e5b90715ffecaa8b97.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA5pyI5Ly06aOe6bG8,size_20,color_FFFFFF,t_70,g_se,x_16)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/dd82c40108bd4639b0b8f05965475a94.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA5pyI5Ly06aOe6bG8,size_20,color_FFFFFF,t_70,g_se,x_16)
